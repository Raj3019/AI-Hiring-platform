...
const {registerEmployee, loginEmployee, profileEmployee, editEmployee, employeeDashboard, uploadResume} = require("../controller/employee.controller")
...
//POST - RESUME UPLOAD
employeeRouter.post("/api/employee/profile/:id/resume", authenticateJWT, upload.single('resume'), uploadResume)
